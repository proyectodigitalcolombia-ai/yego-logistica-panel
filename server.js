...
// Ruta para Render con Disco Persistente
    ...
    try {
        ...
        const info = {
            ...
            t: { 
                ...
                tel: data[17]?.[1] || '', cel: data[17]?.[4] || '', ciu: data[17]?.[7] || '', mail: data[18]?.[1] || '' 
            },
            p: { 
                nom: data[19]?.[1] || '', nit: data[19]?.[4] || '', dir: data[19]?.[7] || '', 
                tel: data[20]?.[1] || '', cel: data[20]?.[4] || '', ciu: data[20]?.[7] || '', mail: data[21]?.[1] || '' 
            },
            r: { 
...
app.post('/guardar', (req, res) => {
    ...
    res.json({ mensaje: "✅ Datos creados/actualizados con éxito." });
});
